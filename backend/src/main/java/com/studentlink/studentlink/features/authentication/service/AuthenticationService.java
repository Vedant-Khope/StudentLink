package com.studentlink.studentlink.features.authentication.service;
...
import com.studentlink.studentlink.features.authentication.utilities.EmailService;
import com.studentlink.studentlink.features.authentication.utilities.Encoder;
import com.studentlink.studentlink.features.authentication.utilities.JsonWebToken;
...
import com.studentlink.studentlink.features.authentication.dto.AuthenticationRequestBody;
import com.studentlink.studentlink.features.authentication.dto.AuthenticationResponseBody;
...
public class AuthenticationService {
    ...
    public void sendEmailVerificationToken(String email) {
        ...
        if (user.isPresent() && !user.get().getEmailVerified()) {
            ...
            String body = String.format("Only one step to take full advantage of StudentLink.\n\n"
    ...
    public AuthenticationResponseBody register(AuthenticationRequestBody registerRequestBody) {
        ...
        String body = String.format("""
                        Only one step to take full advantage of StudentLink.
