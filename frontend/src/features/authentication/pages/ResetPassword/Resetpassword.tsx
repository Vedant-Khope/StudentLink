    ...
    <Layout className={classes.root}>
      ...
      <Box>
        <h1>Reset Password</h1>
        {
          ...
          <p>
            Enter your email and we"ll send a verfifcation matched an existing StudentLink account.
          </p>
          ...
          <Input name='code' type='text' label='Verification code' key="code"/>
          ...
          <Button type="button" outline onClick={() => {setErrorMessage("");setEmailSent(false)}}>Back</Button>
        </form>
        )
